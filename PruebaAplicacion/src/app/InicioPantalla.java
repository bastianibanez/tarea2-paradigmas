...
public class InicioPantalla extends javax.swing.JFrame {
    ...
    private void CargarBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_CargarBMouseClicked
        ...
        if (result == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                preguntas = FileLoader.loadQuestionsFromFile(file);
                ...
                AsignaturaR.setText(FileLoader.getSubject());
                EvaluacionR.setText(FileLoader.getEvaluation());

                long multipleCount = preguntas.stream().filter(q -> q.getType() == model.QuestionType.MULTIPLE).count();
                long tfCount = preguntas.stream().filter(q -> q.getType() == model.QuestionType.TRUE_FALSE).count();
